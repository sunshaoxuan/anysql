...
from anysql.models.schemas import SQLAssistantRequest, SQLAssistantResponse
...
async def assist_sql(req: SQLAssistantRequest):
    ...
    低匹配自动生成并沉淀，带当前 SQL 时按修正意见改写并沉淀。
    """
    ...
    if mode == "matched":
        ...
        text = "已根据修正意见改写 SQL，并自动加入知识库。"
    else:
        text = "没有足够高匹配的 SQL，已根据 Metadata 和既有知识生成新 SQL，并自动加入知识库。"
